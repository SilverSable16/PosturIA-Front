<template>
	...
	<a-layout-sider
		...
		:style="{ backgroundColor: 'transparent',}">
			<router-link to="/home" class="brand" style="display: flex; align-items: center; gap: 0.5rem;">
  <img src="images/logo-ct-black.png" alt="Logo PosturIA" />
  <span>PosturIA</span>
</router-link>
			...
			<a-menu theme="light" mode="inline">
				<a-menu-item>
					<router-link to="/detector">
						...
						<span class="label">Detector de postura</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
					<router-link to="/diagnostico">
						...
						<span class="label">Diagnostico</span>
					</router-link>
				</a-menu-item>
				<a-menu-item>
